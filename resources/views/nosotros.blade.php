...
<div class="container mt-4">
    ...
    <div class="jumbotron text-center">
        ...
        <p>Celebramos cada historia detrás de las colecciones y fomentamos la conexión entre aficionados de todas partes del mundo.</p>
        <p>En Tufi Store, cada clic te acerca a completar tu sueño. Explora nuestra colección hoy y ¡descubre el mundo fascinante de las figuritas!</p>
    </div>
        ...
        <div class="col-md-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <ul>
                        <li><strong>Pasión por el coleccionismo:</strong> Comprometidos con la emoción y la dedicación que implica completar una colección.</li>
                        <li><strong>Confiabilidad:</strong> Ofrecemos un servicio seguro y transparente donde los coleccionistas pueden confiar.</li>
                        <li><strong>Inclusividad:</strong> Reconocemos y valoramos la diversidad de nuestros clientes, desde los más jóvenes hasta los más experimentados.</li>
                        <li><strong>Innovación:</strong> Continuamente buscamos formas de mejorar y simplificar el proceso de búsqueda y adquisición de figuritas.</li>
                        <li><strong>Comunidad:</strong> Fomentamos un sentido de pertenencia y conexión entre coleccionistas de todo el mundo.</li>
                    </ul>
                </div>
            </div>
        </div>
